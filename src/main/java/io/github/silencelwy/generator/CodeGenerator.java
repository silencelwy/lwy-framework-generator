...
public final class CodeGenerator {
     ...
     */
    public static void generator(final String schema, final String modelName, final String... tables) {
     ...
     * @date 2018/5/22 17:54
     */
    public static void generator(final String schema, final String modelName, final String methods, final String... tables) {
        long startTime = System.currentTimeMillis();
        log.info("[{}]生成开始", modelName);
     ...
     */
    public static void generator(final String schema, final String modelName, final String table, final String methods, ArchitectureCode... architectureCodes) {
