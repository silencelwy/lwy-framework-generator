...
public class FreeMakerMongoTemplate {
    private volatile  static FreeMakerMongoTemplate freeMakerTemplate;
    private FreeMakerMongoTemplate(){}

    private static SimpleDateFormat simpleDateFormat = new SimpleDateFormat("MM_dd_HH_mm_ss");
    private static Configuration configuration;

    public static FreeMakerMongoTemplate getFreeMakerTemplate(){
        if(freeMakerTemplate == null){
            synchronized (FreeMakerMongoTemplate.class){
                if(freeMakerTemplate == null){
                    freeMakerTemplate = new FreeMakerMongoTemplate();
                }
            }
        }
     ...
     static {
        ...
        configuration.setClassForTemplateLoading(FreeMakerMongoTemplate.class, "/generator/mongo");
     }
     ...
     */
    public void generateFile(String templateName, MongoCodeVo codeVo) {
